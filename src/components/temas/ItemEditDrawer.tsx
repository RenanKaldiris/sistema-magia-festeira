    ...
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="absolute inset-y-0 right-0 max-w-full flex pl-0 sm:pl-10">
        <div className="w-screen max-w-full sm:max-w-lg bg-white dark:bg-slate-900 shadow-2xl border-l border-slate-200 dark:border-slate-800 flex flex-col animate-in slide-in-from-right duration-250">
          ...
          <div className="p-4 sm:p-5 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between bg-slate-50/80 dark:bg-slate-850/80 backdrop-blur-sm shrink-0">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <span className="text-xs font-mono font-bold text-rose-600 dark:text-rose-400 block truncate">
                  {item.code} • {item.name}
                </span>
              </div>
            </div>
          ...
          {/* Form Body com Scroll independente e Sticky Footer */}
          <form onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0">
            ...
            <div className="sticky bottom-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md px-4 py-3.5 sm:px-6 sm:py-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-end gap-2 shrink-0 z-20">
              ...
              <button
                type="submit"
                disabled={isSaving}
                className="flex-1 sm:flex-none justify-center px-5 py-2.5 rounded-xl bg-rose-600 hover:bg-rose-700 active:bg-rose-800 text-white font-bold shadow-xs text-xs sm:text-sm flex items-center gap-2 transition-colors cursor-pointer disabled:opacity-50"
              >
