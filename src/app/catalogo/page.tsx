        ...
        {filteredThemes.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredThemes.map((theme) => {
              ...
              const whatsappMsg = `Olá! Tenho interesse no tema ${theme.name} (${theme.code})${themeUrl ? ` no catálogo: ${themeUrl}` : ''}. Gostaria de consultar datas!`;
              ...
              return (
                ...
                >
                  {/* Image Container - Vertical 3:4 Aspect Ratio preserving full decor */}
                  <div className="relative aspect-[3/4] w-full bg-slate-100 dark:bg-slate-800 overflow-hidden">
                    {primaryImg ? (
                      ...
                      <div className="w-full h-full flex flex-col items-center justify-center text-slate-400 dark:text-slate-500 p-4">
                        <Sparkles className="w-12 h-12 mb-2 stroke-1 text-slate-300 dark:text-slate-600" />
                        <span className="text-xs font-semibold">Decoração Magia Festeira</span>
                      </div>
                    )}
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between">
                    ...
                    <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        {/* WhatsApp Button: stopPropagation isolates click from parent card link */}
                        <button
                          type="button"
                          onClick={(e) => {
                            e.preventDefault();
                        ...
                        <div
                          className="inline-flex items-center gap-1 px-3.5 py-2.5 rounded-xl bg-rose-600 group-hover:bg-rose-700 text-white text-xs font-semibold shadow-xs transition-colors"
                        >
                          <span>Ver Kits</span>
