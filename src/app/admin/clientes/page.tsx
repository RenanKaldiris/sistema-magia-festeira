  ...
  return (
    <div className="space-y-4 sm:space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-0.5">
            Contatos diretos, histórico de festas anteriores e canais de WhatsApp
          </p>
        </div>
      ...
      <div className="hidden sm:flex text-[11px] text-slate-500 dark:text-slate-400 items-center gap-1.5 px-1">
        ...
        <span>
          <strong>Dica:</strong> Toque em qualquer linha da tabela ou card para abrir a edição rápida e histórico completo de festas.
        </span>
      </div>
