    ...
    <div className="space-y-5 sm:space-y-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/admin/locacoes"
            className="flex-1 sm:flex-initial text-center px-3.5 py-2 bg-rose-600 hover:bg-rose-700 text-white rounded-xl text-xs font-semibold shadow-xs transition-colors"
          >
            + Nova Reserva
          </Link>
          <Link
            href="/admin/temas"
            className="flex-1 sm:flex-initial text-center px-3.5 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 rounded-xl text-xs font-semibold shadow-xs transition-colors"
          >
            Novo Tema
          </Link>
        </div>
      ...
      {!vingadoresCheck.available && (
        <div className="p-3.5 sm:p-5 rounded-2xl bg-amber-500/10 dark:bg-amber-950/30 border border-amber-300 dark:border-amber-800/60 text-amber-900 dark:text-amber-200 flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
          <div className="flex items-center gap-2.5 shrink-0">
            ...
            <h4 className="text-xs sm:text-sm font-bold sm:hidden">Conflito Potencial de Estoque</h4>
          </div>
          ...
          <Link
            href="/admin/locacoes"
            className="self-start sm:self-center px-3 py-1.5 bg-amber-600 hover:bg-amber-700 text-white text-xs font-semibold rounded-lg shrink-0 transition-colors"
          >
            Ver em Locações
          </Link>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-6">
        ...
        <div className="p-3.5 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs flex flex-col justify-between">
          <div className="flex items-center justify-between gap-1">
            <span className="text-[11px] sm:text-xs font-semibold text-slate-500 dark:text-slate-400 truncate">Total de Temas</span>
          ...
          <div className="mt-2 sm:mt-3">
            <div className="text-xl sm:text-3xl font-extrabold text-slate-900 dark:text-white leading-tight">{totalThemes}</div>
            <span className="text-[10px] sm:text-[11px] text-emerald-600 dark:text-emerald-400 font-semibold block sm:inline mt-0.5 sm:mt-0 sm:ml-2">100% ativos</span>
          </div>
        </div>
        ...
        <div className="p-3.5 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs flex flex-col justify-between">
          <div className="flex items-center justify-between gap-1">
            <span className="text-[11px] sm:text-xs font-semibold text-slate-500 dark:text-slate-400 truncate">Peças no Acervo</span>
            <div className="p-1.5 sm:p-2 rounded-xl bg-blue-50 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400 shrink-0">
              <Package2 className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
            </div>
          </div>
          <div className="mt-2 sm:mt-3">
            <div className="text-xl sm:text-3xl font-extrabold text-slate-900 dark:text-white leading-tight">{totalItems}</div>
            <span className="text-[10px] sm:text-[11px] text-slate-400 dark:text-slate-500 block sm:inline mt-0.5 sm:mt-0 sm:ml-2 truncate">unidades físicas</span>
          </div>
        </div>
        ...
        <div className="p-3.5 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs flex flex-col justify-between">
          <div className="flex items-center justify-between gap-1">
            <span className="text-[11px] sm:text-xs font-semibold text-slate-500 dark:text-slate-400 truncate">Reservas Ativas</span>
          ...
          <div className="mt-2 sm:mt-3">
            <div className="text-xl sm:text-3xl font-extrabold text-slate-900 dark:text-white leading-tight">{activeRentals.length}</div>
            <span className="text-[10px] sm:text-[11px] text-emerald-600 dark:text-emerald-400 font-semibold block sm:inline mt-0.5 sm:mt-0 sm:ml-2 truncate">sincronizadas GCal</span>
          </div>
        </div>
        ...
        <div className="p-3.5 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs flex flex-col justify-between">
          <div className="flex items-center justify-between gap-1">
            <span className="text-[11px] sm:text-xs font-semibold text-slate-500 dark:text-slate-400 truncate">Saldo a Receber</span>
            <div className="p-1.5 sm:p-2 rounded-xl bg-violet-50 dark:bg-violet-950/50 text-violet-600 dark:text-violet-400 shrink-0">
              <DollarSign className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
            </div>
          </div>
          <div className="mt-2 sm:mt-3">
            <div className="text-base sm:text-2xl font-extrabold text-slate-900 dark:text-white leading-tight truncate">
              R$ {balanceToReceive.toFixed(2).replace('.', ',')}
            </div>
            <span className="text-[10px] sm:text-[11px] text-slate-400 dark:text-slate-500 block sm:inline mt-0.5 sm:mt-0 sm:ml-2">pendente</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-8">
        ...
        <div className="lg:col-span-7 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-4 sm:p-6 shadow-xs">
          <div className="flex items-center justify-between mb-3.5 sm:mb-4">
            <div>
              <h3 className="text-sm sm:text-base font-bold text-slate-900 dark:text-white">Próximos Eventos & Locações</h3>
              <p className="text-[11px] sm:text-xs text-slate-400 dark:text-slate-500">Controle de datas de montagem e retorno</p>
            </div>
            <Link
              href="/admin/locacoes"
        ...
        <div className="lg:col-span-5 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-4 sm:p-6 shadow-xs flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3.5 sm:mb-4">
              <div>
              ...
              {auditLogs.slice(0, 5).map((log) => (
                <div key={log.id} className="text-xs border-b border-slate-100 dark:border-slate-800 pb-2.5 last:border-0">
                  <div className="flex items-center justify-between gap-2">
                    <span className="font-semibold text-slate-800 dark:text-slate-200 truncate">{log.action}</span>
          ...
          <div className="mt-5 sm:mt-6 p-3.5 sm:p-4 rounded-xl bg-slate-900 dark:bg-slate-800 text-white flex items-center justify-between border border-slate-800 dark:border-slate-700 gap-2">
            <div className="min-w-0">
              <span className="text-[11px] sm:text-xs font-semibold text-slate-400 block truncate">Importações Pendentes</span>
              <span className="text-sm sm:text-lg font-extrabold text-white truncate block">
                {pendingImports.length} lote(s) em revisão
              </span>
            </div>
            <Link
              href="/admin/importacoes"
              className="px-3 py-1.5 rounded-lg bg-rose-600 hover:bg-rose-700 text-white text-xs font-semibold transition-colors shrink-0"
            >
              Revisar
            </Link>
          </div>
